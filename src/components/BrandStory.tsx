...
export function BrandStory() {
  return (
    <section id="story" className="py-24 lg:py-40 bg-brand-gray relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-6xl font-serif text-brand-cream leading-[1.1] mb-8">
              Crafted from <br />
            ...
            <p className="text-brand-cream/70 text-lg leading-relaxed mb-12 font-light">
