...
export function Testimonials() {
  ...
  return (
    <section className="py-16 lg:py-32 bg-brand-bg border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-serif text-brand-text mb-6">Words from Home</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <p className="text-xl lg:text-2xl font-serif text-brand-text/90 italic mb-8 leading-relaxed">
                "{testimonial.text}"
              </p>
              <div className="mt-auto">
                <p className="text-brand-text font-medium tracking-wider uppercase text-sm mb-1">{testimonial.author}</p>
                <p className="text-brand-text/50 text-xs tracking-widest uppercase">{testimonial.location}</p>
              </div>
            </motion.div>
          ))}
        </div>
