...
export function SignatureCollection() {
  ...
  return (
    <section id="shop" className="py-32 lg:py-48 bg-brand-bg relative">
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className="flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 border-t border-brand-text/10 flex justify-between items-center">
