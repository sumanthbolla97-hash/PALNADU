      ...
      <div className="max-w-[100rem] mx-auto px-6 w-full relative z-10">
        ...
        >
          <div className="max-w-md">
            <p className="text-brand-text/90 text-lg md:text-xl font-light leading-relaxed">
          ...
          >
            ...
            <div className="w-12 h-12 rounded-full border border-brand-text/30 flex items-center justify-center group-hover:border-brand-red transition-colors">
        ...
        <motion.h1 
          ...
          className="text-[18vw] 2xl:text-[280px] leading-[0.85] font-serif text-brand-text tracking-tighter uppercase drop-shadow-2xl"
        >
          Palnadu
        </motion.h1>
      </div>
