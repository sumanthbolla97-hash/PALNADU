...
export function Experience() {
  return (
    <section className="py-16 lg:py-32 bg-brand-surface relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl font-serif text-brand-text leading-[1.1] mb-6">
            More Than Spice — <br />
            <span className="italic text-brand-text/80">It’s Experience</span>
          </h2>
        ...
        <motion.div 
          ...
          className="relative aspect-[4/5] lg:aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl shadow-brand-bg/50 order-1 lg:order-2"
        >
          <img 
            src="/Theritual.png" 
            alt="The Ritual" 
